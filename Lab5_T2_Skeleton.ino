...
#define IN1   14  // Replace the ? with the GPIO pin you selected to connect IN1
#define IN2   27   // Replace the ? with the GPIO pin you selected to connect IN2
...
#define IN3  4   // Replace the ? with the GPIO pin you selected to connect IN3
#define IN4  2   // Replace the ? with the GPIO pin you selected to connect IN4
#define AR  23 // Replace the ? with the GPIO pin you selected to connect encoder A of Motor R
#define BR 22 // Replace the ? with the GPIO pin you selected to connect encoder B of Motor R
